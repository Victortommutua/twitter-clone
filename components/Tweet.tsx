...
import { fetchComments } from '../twitter-clone-2/utils/fetchComments'
    ...
    <div className='flex flex-col space-x-3 border-y p-5 border-gray-100'>
      <div className='flex space-x-3'>
        ...
        <div className='mt-5 flex justify-between'>
          <div onClick={() => session && setCommentBoxVisible(!commentBoxVisible)} className='flex cursor-pointer items-center
        ...
        {commentBoxVisible && (
          <form onSubmit={e => handleSubmit}className='flex mt-3 space-x-3'>
            <input 
            value={input}
